...
*Shifan T and Dr. Padmavathy T — School of Computer Science and Engineering, VIT Vellore*
...
```
Shifan T, Padmavathy T. "Attention-Enhanced Spatio-Temporal Deep Learning Model 
for Solar Irradiance Forecasting." VIT Vellore, 2024.
```
...
**Shifan T** — VIT Vellore, School of Computer Science and Engineering
